...
with col2:
    ...
    * **Los conference paper:** Observamos que entre los años 2023 y 2026 hay un total de 13 conference papers, los cuales ocupan la mayor parte del porcentaje del gráfico. Con esto vemos que estos artículos destinados a conferencias o congresos aportan bastante al área de investigación, confirmando que todo lo relacionado con datos, ventas e ia va evolucionando rápidamente.  
    """)
